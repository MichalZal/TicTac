...
const Discover = () => {
  ...
  const { topic } = router.query
	...
	const activeTopicStyle = "xl:border-2 hover:bg-primary xl:border-[#f51997] px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-[#ff1997] transition duration-300";
