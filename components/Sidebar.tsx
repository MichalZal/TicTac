...
const Sidebar = () => {
	...
	const normalLink =
		"flex items-center gap-3 hover:bg-primary padding-3 justify-center xl:justify-start font-semibold cursor:pointer text-[#f51997] rounded";
	...
	return (
		<div>
          ...
          border-r-2 border-gray-200 xl:border-0 p-3"
				>
